...
## Current Status
At this stage, the repository contains the software reference, RTL design, and the fully integrated hardware system:
...
* **Block Design (`bd/`)**: Vivado IP Integrator system connecting the custom IP with Zynq PS, AXI DMA, and AXI GPIO controls.
* **Hardware Overlay (`hw/`)**: Generated Bitstream (`.bit`) and Hardware Handoff (`.hwh`) files ready for deployment on PYNQ.